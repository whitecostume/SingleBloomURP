...
public class SingleBloomRenderFeature : ScriptableRendererFeature
{
    ...
    class SingleBloomRenderPass : ScriptableRenderPass
    {
        ...
        public void Setup(Material bloomMat,int blitStep)
        {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            int[] RT_DownsizeIds = new int[this._blit_step];
            ...
            for (int i = 0; i < RT_DownsizeIds.Length; i++)
            {
            ...
            cmd.Blit(source,RT_DownsizeIds[0],bloomMat,0);
    ...
    {
        m_ScriptablePass.Setup(this.BloomMat, this.BlitStep);
